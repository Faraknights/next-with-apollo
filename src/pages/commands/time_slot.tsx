...
export default function TimeSlotPage() { 
  ...
  return (
		<Layout title='Créneaux'>
			...
			<div className="w-full h-full flex items-start relative justify-center">
				<div className={`absolute top-0 bottom-0 left-0 right-0 z-10 pointer-events-none
												 bg-[linear-gradient(to_right,_#f8fafcff_0%,_#f8fafc00_15%,_#f8fafc00_85%,_#f8fafcff_100%)] 
												 lg:bg-[linear-gradient(to_right,_#f8fafcff_15%,_#f8fafc00_25%,_#f8fafc00_75%,_#f8fafcff_85%)]`}></div>
				
				<div className='lg:w-1/2 w-[80%] flex'>
					{ basket.edges.map((basketCommerce, i) => {
						...
						return (
							<div 
								...
								className={'min-w-full px-5 flex flex-col items-center transition overflow-x-hidden h-full mt-2' + (page == i ? "" : " pointer-events-none")} 
